      ...
      <div className="flex items-center justify-between p-4">
        ...
        <div className="md:hidden">
          ...
          >
            ...
            ></span>
            <span
              className={`block w-5 h-0.5 bg-gray-700 transition-all duration-300 ${isMobileMenuOpen ? 'opacity-0' : ''}`}
            ></span>
            <span
              className={`block w-5 h-0.5 bg-gray-700 transition-all duration-300 ${isMobileMenuOpen ? '-rotate-45 -translate-y-1.5' : ''}`}
            ></span>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-slate-100 border-t border-slate-200">
          <div className="px-4 py-2 space-y-2">
            ...
            <div className="block py-2">
              <a href="#aboutUs" className="pointer-events-none text-gray-400">
